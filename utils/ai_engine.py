...
def _fallback_recommendations(city: str) -> list[dict]:
    ...
    if city == "Houston":
        return [
            {"rank":1,"action":"Brays Bayou Detention Expansion","detail":"Expand detention capacity along Brays Bayou","plain_explanation":"Brays Bayou is a channel that carries rainwater away from neighborhoods. When too much rain falls too fast, it overflows into homes. This project widens the channel and adds extra holding ponds (detention basins) so it can absorb more water before overflowing.","why_this_matters":"Fewer families lose their homes and fewer kids miss school when this bayou floods.","estimated_cost_mn":50,"projected_saving_mn":200,"roi":"4.0x return","evidence":"FEMA HMGP Project Brays reduced flood stages 2-3ft"},
